...
from vitg.utils.autoanchor import check_anchors
...
from vitg.utils.google_utils import attempt_download
from vitg.utils.loss import compute_loss
from vitg.utils.plots import plot_evolution, plot_images, plot_labels, plot_results
from vitg.utils.torch_utils import (
    ModelEMA,
    intersect_dicts,
    select_device,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--weights", type=str, default="yolor-p6.pt", help="initial weights path"
    )
    ...
    parser.add_argument(
        "--labelpath", type=str, default="yolov4.pt", help="initial weights path"
    )
    parser.add_argument(
        "--script", type=str, default="yolov4.pt", help="initial weights path"
    )
    parser.add_argument(
        "--hyp",
        type=str,
