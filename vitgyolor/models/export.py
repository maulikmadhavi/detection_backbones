...
from vitg.utils.activations import Hardswish
from vitg.utils.general import check_img_size, set_logging

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument(
        "--weights", type=str, default="./yolor-p6.pt", help="weights path"
    )
    parser.add_argument(
        "--img-size", nargs="+", type=int, default=[1280, 1280], help="image size"
    )  # height, width
