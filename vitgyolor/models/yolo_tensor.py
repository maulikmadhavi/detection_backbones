...
from vitg.utils.autoanchor import check_anchor_order
from vitg.utils.general import check_file, make_divisible, set_logging
...
if __name__ == "__main__":
    ...
    # img = torch.rand(8 if torch.cuda.is_available() else 1, 3, 1280, 1280).to(device)
