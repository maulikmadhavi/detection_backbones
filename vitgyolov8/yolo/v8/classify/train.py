...
from vitg.network.backbone.vitgyolov8.yolo.data import build_classification_dataloader
...
class ClassificationTrainer(BaseTrainer):
    ...
    def setup_model(self):
        ...
        # Load a YOLO model locally, from torchvision, or from vitg.network.backbone.vitgyolov8 assets
